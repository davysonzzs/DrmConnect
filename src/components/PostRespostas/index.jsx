...
export default function PostRespostas({ id, curtida, modalReport, funcaoDeEnviarId }){
    ...
    return(
        <div className="resps">
            <EnviarResposta idP={id} quantidadeDeCurtidas={curtida} novaRes={buscarRespostas} modalReport={modalReport} funcaoDeEnviarId={funcaoDeEnviarId}/>
